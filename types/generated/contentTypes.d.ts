...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Lesson configuration referencing a question bank';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiLevelLevel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reference taxonomy for question classification';
    displayName: 'Level';
    pluralName: 'levels';
    singularName: 'level';
  };
...
export interface ApiQuestionBankQuestionBank
  ...
  info: {
    description: 'Rules for dynamic question selection';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultQuestionCount: Schema.Attribute.Integer &
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  options: {
    draftAndPublish: false;
    privateAttributes: ['correctAnswer'];
  };
  attributes: {
    content: Schema.Attribute.RichText & Schema.Attribute.Required;
    correctAnswer: Schema.Attribute.JSON & Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
